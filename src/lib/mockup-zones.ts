export interface PrintZone {
  ...
  shape?: 'circle';
  borderRadius?: string;
  /** CSS aspect-ratio for the canvas container; defaults to '1' (square) */
  aspectRatio?: string;
}

/**
 * Print zone positions as percentages of the mockup canvas.
...
export const MOCKUP_PRINT_ZONES: Record<string, PrintZone> = {
  ...
  'poster':         { top: '11%',  left: '11%',  width: '78%',  height: '78%',  aspectRatio: '3/2' },
