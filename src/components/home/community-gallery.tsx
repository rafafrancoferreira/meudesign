...
const GALLERY: GalleryItem[] = [
  ...
  {
    src: '/mock-designs/abstract-1.svg',
    prompt: 'círculos sobrepostos em laranja e creme, dinâmico',
    style: 'abstrato',
    user: 'joao_k',
  },
  {
    src: '/mock-designs/futuristic-1.svg',
  ...
  {
    src: '/mock-designs/nature-2.svg',
    prompt: 'folha botânica detalhada em tons de verde floresta',
    style: 'orgânico',
    user: 'miguel_s',
  },
  {
    src: '/mock-designs/geometric-1.svg',
    prompt: 'mandala sagrada com hexágonos, violeta e dourado',
    style: 'geométrico',
    user: 'carla_v',
  },
  {
    src: '/mock-designs/retro-2.svg',
  ...
  {
    src: '/mock-designs/futuristic-2.svg',
    prompt: 'rede de nodos em grelha futurista verde-néon',
    style: 'futurista',
    user: 'sofia_r',
  },
  {
    src: '/mock-designs/organico-1.svg',
